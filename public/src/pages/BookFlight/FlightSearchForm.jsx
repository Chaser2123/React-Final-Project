...
export default function FlightSearchForm({ defaults = {}, onSearch }) {
  ...
  const searchFlights = (e) => {
    e.preventDefault();
    if (onSearch) {
      onSearch(departure, arrival, outbound, returnd);
    }
  }

  return (
    <form className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2" onSubmit={searchFlights}>
