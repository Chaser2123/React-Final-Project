...
export default function SeatMap({ flightNumber, flightRowsCount = 20, seatsPerRow = 8 }) {
                        ...
                        <div key={rowIndex} className="flex items-center gap-2">
                            ...
                            <div className="flex gap-2">
                                {row.slice(0, seatsPerSide).map((seatId) => (
                                    <button
                                        key={seatId}
                                        className="w-10 h-10 bg-blue-500 hover:bg-blue-600 text-white rounded font-mono text-sm transition-colors"
